...
export default function FanScreen() {
  ...
  const moneyRain = useSharedValue(0);
        ...
        >
          ...
          <View style={styles.headerRow}>
            ...
            <TouchableOpacity
              ...
              style={[styles.walletPill, { backgroundColor: colors.card, borderColor: colors.gold }]}
            >
          ...
          <ScrollView
            ...
            contentContainerStyle={styles.djScroll}
          >
            {liveDjs.map((dj) => {
              ...
              return (
                ...
                >
                  ...
                  <Text style={[styles.djGenre, { color: colors.mutedForeground }]}>
                    {dj.genre}
                  </Text>
                  {dj.totalTipsToday > 0 && (
                    <Text style={[styles.djTips, { color: colors.gold }]}>
                      {dj.totalTipsToday}€ ce soir
                    </Text>
                  )}
                </TouchableOpacity>
              );
          ...
          {selectedDj && (
            ...
            >
              <MaterialCommunityIcons
                ...
                color={colors.violet}
              />
              <Text style={[styles.selectedDjText, { color: colors.foreground }]}>
                {selectedDj.name}
              </Text>
          ...
          <View style={styles.bottomActionsRow}>
            <TouchableOpacity
              ...
              style={[
                ...
                {
                  backgroundColor: showCustom ? colors.violet : colors.secondary,
                  borderColor: showCustom ? colors.violet : colors.border,
                },
              ]}
            >
              <MaterialCommunityIcons
              ...
              />
              <Text style={[styles.enterAmountText, { color: colors.foreground }]}>
                Montant
              </Text>
            </TouchableOpacity>
          ...
          <Animated.View style={sendBtnStyle}>
            ...
            >
              <Feather
                name={lastSentSuccess ? "check" : "zap"}
                size={20}
                color={lastSentSuccess ? "#000" : "#fff"}
              />
              <Text
                style={[
                  styles.sendBtnText,
          ...
          {wallet.balance < 5 && (
            ...
            >
              ...
              <Text style={[styles.rechargeText, { color: colors.gold }]}>
                Solde faible — Recharger le portefeuille
              </Text>
